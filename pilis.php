...
<html lang="lt">
  ...
  <header>
    ...
    <?php
      ...
      $sql = "SELECT * FROM pilys WHERE id='".$_GET['id']."'";
      if($result = mysqli_query($conn, $sql)){
        if(mysqli_num_rows($result) > 0){
          while($row = mysqli_fetch_array($result)){
            echo " <ul class='breadcrumb'>";
            echo " <li><a href='index.html'>Pagrindinis</a></li>";
            echo " <li><a href='pilys.php'>Pilys</a></li>";
            ...
            if($row['archtektura'] != NULL){
              echo " <h2>Architektūra</h2>";
              echo "<p> " . $row['archtektura'] . "</p>";
            }
    ...
    <script>
      ...
      function atgal(){
        window.location.href='pilys.php';
      }
    </script>
    <footer class="footer">
